...
<walkmod>
  <plugins>
    <plugin groupId="org.walkmod" artifactId="walkmod-maven-plugin" version="[1.0, 2.0)" />
    <plugin groupId="org.walkmod" artifactId="walkmod-refactor-plugin" version="[2.0, 3.0)" />
  </plugins>
  <conf-providers>
