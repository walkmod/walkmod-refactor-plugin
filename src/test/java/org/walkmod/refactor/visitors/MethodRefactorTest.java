...
public class MethodRefactorTest extends SemanticTest {
   ...
   public CompilationUnit getRefactoredSource(Map<String, String> methodRules, String... code) throws Exception {
   ...
   public void testSimpleMethodCall() throws Exception {
      ...
      rules.put("java.io.PrintStream:print(java.lang.String text)", "java.io.PrintStream:println(text)");
   ...
   public void testMultipleMethodCall() throws Exception {
      ...
      Map<String, String> rules = new HashMap<String, String>();
      rules.put("java.lang.String:substring(int pos)", "java.lang.String:concat(\"a\")");
   ...
   public void testResultTransformations() throws Exception {
      String code = "import java.io.File; public class A { public void hello(File file){ " + "Bar bar = new Bar(); "
            + "bar.open(file); " + "if(bar.isOpen()){}" + " }}";
   ...
   @Test
   public void testRefactoringVisitors() throws Exception {
      String code = "import java.io.File; public class Bar { public boolean isOpen(File file){return false;}}";

      Map<String, String> rules = new HashMap<String, String>();
      rules.put("Bar:isOpen(java.io.File file)", "Bar:isOpen()");
      ...
      refactoringVisitors.put(md.getSymbolData().getMethod(), new VoidVisitorAdapter<VisitorContext>() {

         public void visit(MethodDeclaration md, VisitorContext ctx) {
            md.setParameters(null);
         }
      ...
      coi.setRefactoringRules(rules);
      
      coi.setRefactoringVisitors(refactoringVisitors);
